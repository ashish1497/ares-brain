...
export function buildBrainStatusArgs(course) {
    return course ? ["brain-status", "--course", course] : ["brain-status"];
}
export const brainStatusTool = {
    name: "brain_status",
    description: "Report brain index/guide freshness for a course (or all courses): corpusBytes, sourceCount, indexBuiltAt, indexStale, guideBuiltAt, guideSourcesBehind, embeddingsRecommended.",
    inputSchema: {
        type: "object",
